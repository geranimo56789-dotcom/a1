#!/usr/bin/env python3
"""
League 1 Logo Scraper - Fixed Version with Verified URLs
Downloads team logos from all major European leagues with working URLs
"""
import os
import sys
...
class League1LogoScraperFixed:
    def __init__(self):
        ...
        # VERIFIED WORKING URLs - All tested and confirmed
        self.team_logos = {
            ...
            # England - Premier League (20 teams) - VERIFIED URLs
            "England_Premier": {
            ...
            # Spain - La Liga (20 teams) - VERIFIED URLs
            "Spain_LaLiga": {
            ...
            # Italy - Serie A (20 teams) - VERIFIED URLs
            "Italy_SerieA": {
            ...
            # Germany - Bundesliga (18 teams) - VERIFIED URLs
            "Germany_Bundesliga": {
...
def main():
    scraper = League1LogoScraperFixed()
    ...
    if len(sys.argv) > 1:
        ...
        if command == "list":
            ...
            print("Usage:")
            print("  python league1_logo_scraper_fixed.py list                    - List all leagues")
            print("  python league1_logo_scraper_fixed.py league <league_name>    - Download specific league")
            print("  python league1_logo_scraper_fixed.py all                     - Download all leagues")
            print("\nExample:")
            print("  python league1_logo_scraper_fixed.py league France_Ligue1")
    else:
